								...
								<td>
									<div class="d-flex align-items-center">
										<div class="symbol symbol-50px me-3">
											<img src="{{ url('assets/media/stock/img-49.jpg' ) }}" class="" alt="" />
										</div>
		...
		<div class="card card-flush py-4">
			...
			<div class="card-body pt-0">
				...
				<select class="form-select mb-2" data-control="select2" data-hide-search="true" data-placeholder="Select an option" id="kt_ecommerce_add_product_status_select">
					<option></option>
					<option value="published" selected="selected">Aprobado</option>
					<option value="draft">Pendiente</option>
					<option value="scheduled">Por revisar</option>
					<option value="inactive">Denegado</option>
				</select>
				<!--end::Select2-->
				<!--begin::Description-->
...
@section('scripts')
<script src="{{ url('assets/js/usuarios/save-product.js') }}"></script>
@endsection
