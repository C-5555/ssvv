    ...
    <div class="app-page flex-column flex-column-fluid" id="kt_app_page">
        ...
        <div id="kt_app_header" class="app-header">
            ...
            <div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
                <a href="{{ url('ssvv/../ssvv') }}" class="d-lg-none">
                ...
                <div data-kt-swapper="true" data-kt-swapper-mode="{default: 'prepend', lg: 'prepend'}"
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                        ...
                        <li class="breadcrumb-item text-muted">
                            <a href="{{ url('/ssvv/../ssvv') }}" class="text-muted text-hover-primary">Inicio</a>
                        </li>
                        <!--end::Item-->
                    </ul>
                     <!--end::Breadcrumb-->
                                ...
                                <div data-kt-search-element="wrapper">
                                    ...
                                    <div class="mb-5" data-kt-search-element="main">
                                        ...
                                        <div class="d-flex flex-stack fw-semibold mb-4">
                                            <!--begin::Label-->
                                            <span class="text-muted fs-6 me-2">Recently Searched:
                                        ...
                                        <ul class="nav nav-line-tabs nav-line-tabs-2x nav-stretch fw-semibold px-9">
                                            <li class="nav-item">
                                                <a class="nav-link text-white opacity-75 opacity-state-100 pb-4"
                                                    data-bs-toggle="tab" href="#kt_topbar_notifications_1">Mensajes</a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link text-white opacity-75 opacity-state-100 pb-4 active"
                                                    data-bs-toggle="tab" href="#kt_topbar_notifications_2">Respuesta</a>
                                            </li>
                                        </ul>
                                        <!--end::Tabs-->
                                    </div>
...
<!--begin::Logo image-->
<a href="{{ url('/ssvv/../ssvv') }}">
<img alt="Logo" src="{{ url('assets/media/logos/SSVV.png') }}" class="h-40px app-sidebar-logo-default" />
<img alt="Logo" src="{{ url('assets/media/logos/destination.png' )}}" class="h-35px app-sidebar-logo-minimize" />
</a>
<!--end::Logo image-->
            ...
            <div class="menu menu-column menu-rounded menu-sub-indention px-3" id="#kt_app_sidebar_menu"
                ...
                <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                    ...
                    <div class="menu-sub menu-sub-accordion">
                        ...
                        <!--begin:Menu link-->
                        <a class="menu-link" href="/ssvv/public/ssvv/vacaciones">
                            <span class="menu-bullet">
                                <span class="bullet bullet-dot"></span>
                            </span>
                ...
                <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                    ...
                    <div class="menu-sub menu-sub-accordion">
                        ...
                        <div class="menu-item">
                            <!--begin:Menu link-->
                            <a class="menu-link" href="/ssvv/public/ssvv/mensajes">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
                        ...
                        <div class="menu-item">
                            <!--begin:Menu link-->
                            <a class="menu-link" href="/ssvv/public/ssvv/viaticos"> <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
                            ...
                            <div class="menu-sub menu-sub-accordion">
                                ...
                                <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                    ...
                                    <div class="menu-sub menu-sub-accordion">
                                        ...
                                        <div class="menu-item">
                                            <!--begin:Menu link-->
                                            <a class="menu-link" href="/ssvv/viaticos">
                                                <span class="menu-bullet">
                                                    <span class="bullet bullet-dot"></span>
                                                </span>
