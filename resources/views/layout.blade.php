					...
					<div class="app-container container-fluid d-flex align-items-stretch justify-content-between"
							...
							<div class="btn btn-icon btn-active-color-primary w-35px h-35px"
								...
								<span class="svg-icon svg-icon-1">
									<svg width="24" height="24" viewBox="0 0 24 24" fill="none"
										xmlns="{{ url('assets/media/logos/destination.png') }}">
						...
						<div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
							<a href="{{ url('ssvv/../ssvv') }}" class="d-lg-none">
								<img alt="Logo" src="{{ url('assets/media/logos/destination.png') }}" class="h-30px" />
							</a>
						</div>
						<!--end::Mobile logo-->
							...
							<div data-kt-swapper="true" data-kt-swapper-mode="{default: 'prepend', lg: 'prepend'}"
								...
								<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
									...
									<li class="breadcrumb-item text-muted">
										<a href="{{ url('/ssvv') }}" class="text-muted text-hover-primary">Inicio</a>
									</li>
									<!--end::Item-->
								</ul>
								<!--end::Breadcrumb-->
								...
								@can('users.form')
									<div data-kt-menu-trigger="click" class="menu-item menu-accordion">
										...
										<div class="menu-sub menu-sub-accordion">
											<!--begin:Menu link-->
											<a class="menu-link" href="{{ url('/ssvv/viaticos') }}">
											...
											<!--begin:Menu link-->
											<a class="menu-link" href="{{ url('/ssvv/vacaciones') }}">
												<span class="menu-bullet">
													<span class="bullet bullet-dot"></span>
												</span>
										...
										<div class="menu-sub menu-sub-accordion">
											...
											<div data-kt-menu-trigger="click" class="menu-item menu-accordion mb-1">
												...
												<div class="menu-sub menu-sub-accordion">
													...
													<div class="menu-item">
														<!--begin:Menu link-->
														<a class="menu-link" href="{{ url('/ssvv/formActas') }}">
															<span class="menu-bullet">
																<span class="bullet bullet-dot"></span>
															</span>
											...
											<div data-kt-menu-trigger="click" class="menu-item menu-accordion">
												...
												<div class="menu-sub menu-sub-accordion">
													...
													<div class="menu-item">                        
														<!--begin:Menu link-->
														<a class="menu-link" href="{{ url('/ssvv/roles') }}">
															<span class="menu-bullet">
																<span class="bullet bullet-dot"></span>
															</span>
